...
class CurrencyApiTest {
    ...
    void api_with_success() {
        ...
        //Assert
        assertEquals("{\"id\":1,\"name\":\"YEN\",\"exchangeRateToBaht\":3.33,\"cashList\":[]}"
                ,result.getData());
        CurrencyResponse result2 = testRestTemplate.getForObject("/currency", CurrencyResponse.class);
        //Assert
        assertEquals("[{\"id\":1,\"name\":\"YEN\",\"exchangeRateToBaht\":3.33,\"cashList\":[]},{\"id\":2,\"name\":\"USD\",\"exchangeRateToBaht\":0.33,\"cashList\":[]}]"
                ,result2.getData());
        ...
        //Assert
        assertEquals("[{\"id\":1,\"name\":\"YEN\",\"exchangeRateToBaht\":3.33,\"cashList\":[]},{\"id\":2,\"name\":\"SPX\",\"exchangeRateToBaht\":0.33,\"cashList\":[]}]"
                ,result3.getData());
    }
}